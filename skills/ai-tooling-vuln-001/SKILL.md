---
name: ai-tooling-vuln-001
description: "CVE-Factory (Luo et al 适用于: 目标系统使用 PyTorch/TensorFlow 等 AI 框架; 系统使用 LangChain/LlamaIndex 等 LLM 编排框架; vLLM/TGI 等模型推理服务暴露在网络上"
license: MIT
metadata:
...
`pytorch cve`, `tensorflow vuln`, `langchain security`, `llm framework 漏洞`, `safetensors`, `pickle deser`, `model injection`, `ai supply chain`, `vllm exploit`, `ray cluster`, `mlflow`
...
`AI framework vulnerability scan`, `AI 框架安全检测`, `ML supply chain audit`, `模型加载安全`
