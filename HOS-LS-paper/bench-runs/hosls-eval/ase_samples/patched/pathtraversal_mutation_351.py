...
async def document_upload(
    ...
    try:
        if doc_file:
            ...
            # Use sanitized filename for the move operation
            shutil.move(
                tmp_path,
                os.path.join(KNOWLEDGE_UPLOAD_ROOT_PATH, space_name, safe_filename),
            )
            ...
            request.content = os.path.join(
                KNOWLEDGE_UPLOAD_ROOT_PATH, space_name, safe_filename
            )
