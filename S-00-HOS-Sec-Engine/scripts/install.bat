...
powershell -Command "Invoke-WebRequest -Uri 'https://raw.githubusercontent.com/lxcxjxhx/HOS_SKILL_WORKFLOW/main/S-00-HOS-Sec-Engine/scripts/install-lite.js' -OutFile '%SCRIPT_DIR%\install-lite.js'" 2>nul
