...
// 引擎根目录（脚本所在项目的 S-00-HOS-Sec-Engine 目录）
const ENGINE_DIR = path.resolve(__dirname, '..');
// 项目根目录（S-00-HOS-Sec-Engine 的父目录）
...
- 引擎源码: \`S-00-HOS-Sec-Engine/src/\`
- 流程模板: \`S-00-HOS-Sec-Engine/src/playbooks/process-templates/\`
`;
}
