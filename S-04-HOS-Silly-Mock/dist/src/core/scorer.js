...
exports.calculateRealityScore = calculateRealityScore;
exports.calcMockLeakageRisk = calcMockLeakageRisk;
exports.calcRegexAbuseRisk = calcRegexAbuseRisk;
exports.hasSilentFailure = hasSilentFailure;
exports.bindingPassed = bindingPassed;
 ...
 */
function calculateRealityScore(findings) {
    ...
    for (const [layer, layerFindings] of byLayer) {
        const weight = LAYER_WEIGHTS[layer] || 0.15;
        let layerPenalty = 0;
 ...
 */
function calcMockLeakageRisk(score) {
    if (score <= 30)
        return 'critical';
    if (score <= 50)
        return 'high';
 ...
 * 计算 Regex Abuse 风险等级
 */
function calcRegexAbuseRisk(findings) {
 ...
 */
function hasSilentFailure(findings) {
 ...
 */
function bindingPassed(findings) {
