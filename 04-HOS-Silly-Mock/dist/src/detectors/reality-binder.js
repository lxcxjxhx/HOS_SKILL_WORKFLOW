...
exports.hasIO = hasIO;
exports.traceVariable = traceVariable;
exports.detectRealityBinding = detectRealityBinding;
 ...
 * 提取赋值语句的左侧变量名
 */
function extractAssignedVar(line) {
    // const x = ..., let x = ..., var x = ...
 ...
 */
function traceVariable(varName, defLine, lines) {
    const result = {
        name: varName,
        complete: false,
    };
 ...
 * Layer 3 检测入口
 */
function detectRealityBinding(file, lines, config = types_1.DEFAULT_CONFIG) {
    const findings = [];
    const options = config.binding;
    if (!options.checkSource && !options.checkSink)
        return findings;
...
//# sourceMappingURL=reality-binder.js.map