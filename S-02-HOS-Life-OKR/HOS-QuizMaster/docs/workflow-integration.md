...
本文档说明如何将 HOS-QuizMaster 集成到 HOS_SKILL_WORKFLOW 的 S-02-HOS-LIFE-OKR 模块中。

## 概述

HOS-QuizMaster 作为标准化 skill 被 S-02-HOS-LIFE-OKR 工作流调用，实现学习任务的自动化调度和执行。
...
```yaml
# S-02-HOS-LIFE-OKR/workflows/daily-quiz.yaml
actions:
  - name: 每日刷题
    action: quizmaster
