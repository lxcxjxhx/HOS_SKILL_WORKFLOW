...
**知识产权写作技能体系 — 覆盖论文、专利、软著、书籍、博客、润色六大场景**

[快速开始](#-快速开始) • [使用示例](#-使用示例) • [架构](#-架构) • [许可证](#-许可证)
...
HOS-IP-Writing 是一个统一的知识产权写作技能系统，提供从学术论文到专利申请的完整写作支持。系统采用智能路由机制，根据用户意图自动激活对应的子技能，并支持跨技能协作管线。

### ✨ 核心特性

- **六大场景覆盖**：论文、专利、软著、书籍、博客、文本润色
- **智能路由**：根据用户意图自动选择最佳子技能
- **共享上下文**：跨子技能信息无缝传递
- **质量门禁**：每个阶段都有明确的验收标准
- **跨技能管线**：预定义 4 条管线覆盖常见多技能协作场景
- **HOS 生态集成**：与 Sec-Engine、Fuck-Demo、Silly-Mock、Vibe-Guard 等模块深度集成
