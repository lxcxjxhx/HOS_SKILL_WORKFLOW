/**
 * HOS-Sec-Engine V2 - CPS AI Agent Security Skill
 * 基于 SENTINEL 框架 (Hatami et al., 2026) 的信息物理系统 AI 代理安全测试
 * 覆盖: Agent-Environment 交互攻击, 深度伪造, MCP介导漏洞, 传感器欺骗
 */
...
export const cpsAiAgentSecuritySkills: AttackDefenseSkill[] = [
    {
        metadata: {
            ...
            name: 'CPS AI Agent Security Assessment',
            category: 'cps',
            subCategory: 'ai-agent-security',
            riskLevel: 'critical',
            confidence: 0.87,
            updatedAt: '2026-06',
            author: 'HOS-Sec-Engine',
            tags: [
                'cps', 'cyber-physical', 'ai-agent', 'sentinel',
                'deepfake', 'sensor-spoofing', 'mcp', 'scada',
                'industrial-control', 'smart-grid', 'iot',
                'agent-environment', 'aigc', 'physics-grounded',
            ],
        },
        trigger: {
            scenarios: [
            ...
            keywords: [
                'cps', 'cyber-physical', 'sensor spoofing', 'deepfake',
                'ai agent', 'mcp cps', 'scada', 'industrial control',
                'smart grid', '物理安全', '传感器欺骗',
                'sentinel framework', 'aigc attack',
            ],
            aliases: [
                'CPS AI red team',
                '信息物理系统安全',
                'AI agent physical attack',
                'sensor manipulation test',
                '工控AI安全',
            ],
            indicators: [
        ...
        knowledge: {
            description: 'AI 代理在信息物理系统(CPS)中的集成引入了超越传统网络或物理威胁模型的新型安全风险。SENTINEL 综述 (Hatami et al., Binghamton Univ., 2026) 系统分析了 AI 代理在 CPS 中的安全问题，提出了六阶段方法论：威胁特征化 → CPS 约束下的可行性分析 → 防御选择 → 纵深防御 → 验证 → 持续适应。核心攻击面包括：(1) Agent-Environment 交互操纵：攻击者通过注入定制输入或操控环境信号迫使不安全动作；(2) Deepfake 驱动的攻击：深度伪造视频/音频/传感器数据欺骗 AI 感知；(3) MCP 介导漏洞：跨域上下文传播导致物理系统误操作。',
            symptoms: [
                '传感器读数与物理实际状态不一致',
                'AI 视觉系统无法识别明显的物理异常',
                '语音控制系统对非预期指令做出响应',
        ...
        action: {
            checklist: [
                '** Phase1: 威胁特征化 — 识别 AI Agent 类型、传感器配置、物理执行器',
                '** Phase2: CPS约束分析 — 评估实时性/算力/安全关键性约束',
                '** Phase3: 传感器欺骗测试 — 测试传感器数据注入/篡改/重放',
                '** Phase4: Deepfake感知测试 — 测试视觉/音频 AI 的深度伪造抗性',
                '** Phase5: MCP跨域测试 — 检测 MCP 在 CPS 中的上下文传播安全',
                '** Phase6: Agent决策操纵 — 测试环境信号是否能误导 Agent 决策',
                '** Phase7: 纵深防御评估 — 验证多层防御的有效性',
                '** Phase8: 持续适应验证 — 检查攻击检测的更新机制',
            ],
            techniques: [
            ...
            examples: [
                {
                    name: '传感器数据注入攻击',
                    description: '伪造温度传感器读数误导工业控制 AI 做出危险决策',
                    content:
                ...
                {
                    name: 'Deepfake 视觉欺骗攻击',
                    description: '使用深度伪造视频帧欺骗 AI 安防监控系统',
                    content:
                        '攻击场景: 变电站 AI 视觉安防监控\n' +
                ...
                {
                    name: 'MCP 跨 CPS 域上下文投毒',
                    description: '通过 MCP 协议在 CPS 域间传播恶意上下文操纵物理系统',
                    content:
        ...
        runtime: {
            ...
            dependencies: ['mcp-security-audit-001'],
